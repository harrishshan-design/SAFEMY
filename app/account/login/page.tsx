  ...
  return (
    <main>
      <section className="form-hero shell">
        ...
        <h1>Sign in.</h1>
        <p>An account is optional — you can still <Link href="/request">request protection</Link> without one. Sign in to see your past and active requests in one place.</p>
      </section>
...
function LoginForm() {
  ...
  return (
    <form className="form-card" onSubmit={handleSubmit}>
      ...
      <p className="form-note">No account yet? <Link href="/account/signup">Create one</Link>.</p>
    </form>
  );
}
